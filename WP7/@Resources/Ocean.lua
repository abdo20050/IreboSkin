...
function Update()
  ...
  measureBuffer[lowerLimit], measureBuffer[lowerLimit+1], measureBuffer[upperLimit-1], measureBuffer[upperLimit] = 0, 0, 0, 0
  measureBuffer[lowerLimit+2] = 0.33 * (measureBuffer[lowerLimit+2])
  measureBuffer[lowerLimit+3] = 0.66 * (measureBuffer[lowerLimit+2] + measureBuffer[lowerLimit+3])
  measureBuffer[upperLimit-2] = 0.33 * (measureBuffer[upperLimit-2])
  measureBuffer[upperLimit-3] = 0.66 * (measureBuffer[upperLimit-2] + measureBuffer[upperLimit-3])
